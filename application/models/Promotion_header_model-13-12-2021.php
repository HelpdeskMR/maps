...
class Promotion_header_model extends CI_Model
{
    ...
    function json()
    {
        ...
        if ($this->session->userdata('id_user_level') == 1 || $this->session->userdata('id_user_level') == 8 || $this->session->userdata('id_user_level') == 14 || $this->session->userdata('id_user_level') == 15) {
    ...
    function get_store($channel_code, $kode_departemen)
    {
    ...
    function get_region($channel_code, $kode_departemen)
    {
    ...
    /* GET APPROVAL */
    function get_approval_tm($kode_departemen, $channel_code, $region_code, $store_code, $total_budget)
    {
    ...
    function get_approval_ka($kode_departemen, $channel_code, $store_code, $total_on_top_promo, $total_budget)
    {
    ...
    function get_approval_ec($kode_departemen, $channel_code, $total_budget)
    {
    ...
    function get_financial_kpi($promotion_number)
    {
        $this->db->select('*', FALSE);
        $this->db->where('promotion_number', $promotion_number);
    ...
    function get_product($promotion_number)
    {
        ...
        SUBSTRING_INDEX(GROUP_CONCAT(product_category.category_name SEPARATOR ','),',',-1) as cotegory_name_1,
        SUBSTRING_INDEX(GROUP_CONCAT(product_category.category_name SEPARATOR ','),',',1) as cotegory_name_2", FALSE);
        $this->db->where('promotion_number', $promotion_number);
        $this->db->join('product_list', 'product_list.product_code = product.product_code', 'left');
        $this->db->join('product_category', 'product_category.category_id = product.category_1 OR product_category.category_id = product.category_2', 'left');
        $this->db->group_by('product.product_code');
        $query = $this->db->get('product');
        return $query->result();
    }

    function get_on_top_promo($promotion_number)
    {
    ...
    function get_trading($promotion_number)
    {
        ...
        $this->db->where('trading_term.promotion_number', $promotion_number);
        $query = $this->db->get('trading_term');
        $data = $query->result();
        return $data;
    }
    ...
    function get_product_category_1($product_code)
    {
        $this->db->select('product_list.product_code,
        product_list.product_name,
        product_list.category_1,
        product_category.category_name', false);
        $this->db->where('product_code', $product_code);
        $this->db->join('product_category', 'product_category.category_id = product_list.category_1', 'left');
        $query = $this->db->get('product_list');
        return $query;
    }

    function get_product_category_2($product_code)
    {
        $this->db->select('product_list.product_code,
        product_list.product_name,
        ...
        product_category.category_name', false);
        $this->db->where('product_code', $product_code);
        $this->db->join('product_category', 'product_category.category_id = product_list.category_2', 'left');
        $query = $this->db->get('product_list');
        return $query;
    }
    ...
    function get_financial_kpi_export($promotion_number)
    {
        $this->db->select('*', FALSE);
        $this->db->where('promotion_number', $promotion_number);
        $query = $this->db->get('financial_kpi');
    ...
    function get_on_top_promo_export($promotion_number)
    {
        $this->db->select('on_top_promo.gl_coa_segment,
        on_top_promo.gl_account_code,
        on_top_promo.amount,
    ...
    // insert Workflow Edit Budget Promotion
    ...
    function json_additionalBudget()
    {
        ...
        $this->datatables->join('wf_edit_budget', 'additional_budget.promotion_number = wf_edit_budget.promotion_number AND additional_budget.approval_scheme = wf_edit_budget.approval_scheme');
        $this->datatables->join('tbl_user', 'wf_edit_budget.id_users = tbl_user.id_users');
        $this->datatables->add_column('action', anchor(site_url('additional_budget/read/$1'), '<i class="fa fa-eye" aria-hidden="true"></i>', array('class' => 'btn btn-success btn-sm')), 'promotion_id');
    ...
    function get_approve_edit1($promotion_number)
    {
        ...
        tbl_user_level.nama_level,
        tbl_user.full_name', FALSE);
        $this->db->join('tbl_user_level', 'wf_edit_budget.id_user_level = tbl_user_level.id_user_level');
        $this->db->join('tbl_user', 'wf_edit_budget.id_users = tbl_user.id_users');
        $this->db->where('wf_edit_budget.promotion_number', $promotion_number);
        $this->db->where('wf_edit_budget.approval_scheme', '1');
        $query = $this->db->get('wf_edit_budget');
        $data = $query->result_array();
        return $data;
    }

    function get_approve_edit2($promotion_number)
    {
        $this->db->select('wf_edit_budget.id,
        wf_edit_budget.promotion_number,
        wf_edit_budget.kode_departemen,
        ...
        $this->db->join('tbl_user', 'wf_edit_budget.id_users = tbl_user.id_users');
        $this->db->where('wf_edit_budget.promotion_number', $promotion_number);
        $this->db->where('wf_edit_budget.approval_scheme', '2');
        $query = $this->db->get('wf_edit_budget');
        $data = $query->result_array();
        return $data;
    }

    function get_approve_edit3($promotion_number)
    {
        $this->db->select('wf_edit_budget.id,
        wf_edit_budget.promotion_number,
        wf_edit_budget.kode_departemen,
        ...
        $this->db->join('tbl_user', 'wf_edit_budget.id_users = tbl_user.id_users');
        $this->db->where('wf_edit_budget.promotion_number', $promotion_number);
        $this->db->where('wf_edit_budget.approval_scheme', '3');
        $query = $this->db->get('wf_edit_budget');
        $data = $query->result_array();
        return $data;
    }

    function get_approve_edit4($promotion_number)
    {
        $this->db->select('wf_edit_budget.id,
        wf_edit_budget.promotion_number,
        wf_edit_budget.kode_departemen,
        ...
        $this->db->join('tbl_user', 'wf_edit_budget.id_users = tbl_user.id_users');
        $this->db->where('wf_edit_budget.promotion_number', $promotion_number);
        $this->db->where('wf_edit_budget.approval_scheme', '4');
        $query = $this->db->get('wf_edit_budget');
        $data = $query->result_array();
        return $data;
    }

    function get_approve_edit5($promotion_number)
    {
        $this->db->select('wf_edit_budget.id,
        wf_edit_budget.promotion_number,
        wf_edit_budget.kode_departemen,
        ...
        $this->db->join('tbl_user', 'wf_edit_budget.id_users = tbl_user.id_users');
        $this->db->where('wf_edit_budget.promotion_number', $promotion_number);
        $this->db->where('wf_edit_budget.approval_scheme', '5');
        $query = $this->db->get('wf_edit_budget');
        $data = $query->result_array();
        return $data;
    }

    function get_approve_edit6($promotion_number)
    {
        $this->db->select('wf_edit_budget.id,
        wf_edit_budget.promotion_number,
        wf_edit_budget.kode_departemen,
        ...
        $this->db->join('tbl_user', 'wf_edit_budget.id_users = tbl_user.id_users');
        $this->db->where('wf_edit_budget.promotion_number', $promotion_number);
        $this->db->where('wf_edit_budget.approval_scheme', '6');
        $query = $this->db->get('wf_edit_budget');
        $data = $query->result_array();
        return $data;
    }

    function get_approve_edit7($promotion_number)
    {
        $this->db->select('wf_edit_budget.id,
        wf_edit_budget.promotion_number,
        wf_edit_budget.kode_departemen,
        ...
        $this->db->join('tbl_user', 'wf_edit_budget.id_users = tbl_user.id_users');
        $this->db->where('wf_edit_budget.promotion_number', $promotion_number);
        $this->db->where('wf_edit_budget.approval_scheme', '7');
        $query = $this->db->get('wf_edit_budget');
        $data = $query->result_array();
        return $data;
    }
