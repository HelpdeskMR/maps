      ...
      <div class="nav-tabs-custom">
        ...
        <div class="tab-content">
          <div class="tab-pane active" id="tab_1">
            <div class="row">
              <div class="box box-warning box-solid"> <?php echo $this->session->flashdata('message'); ?>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <div class="col-sm-3">
                            <input type="date" class="form-control" name="tgl_claim" id="tgl_claim" value="<?php date_default_timezone_set('Asia/Jakarta');
                                                                                                            $now = date('Y-m-d');
                      ...
                      <div class="col-md-6">
                        ...
                        <div class="form-group">
                          <label class="col-sm-3 control-label">Nomor Promosi</label>
                          <div class="col-sm-5"> 
                            <!-- <select class="form-control select2" id="promotion_number" name="promotion_number" required style="width: 100%;">
                              <option></option>
                              <?php $no = 0;
                            ...
                            <input type="text" class="form-control" name="promotion_number" id="promotion_number" placeholder="Promotion Number" value="<?php echo $promotion_number; ?>" />
                            <span class="input-group-btn">
                            <button type="button" class="btn btn-info" data-toggle="modal" data-target="#modal-promotion"> <i class="fa fa-search"></i> </button>
                            </span> </div>
                        </div>
                        <div class="form-group">
                          <label class="col-sm-3 control-label">Nama Promosi</label>
                          <div class="col-sm-9">
...
<div class="modal face" id="modal-item">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">$times;</span> </button>
        <h4 class="modal-title">Pilih Nama Promosi</h4>
      </div>
    </div>
  </div>
</div>
