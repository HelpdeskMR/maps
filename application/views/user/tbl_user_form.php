<div class="content-wrapper">
  ...
  <div class="box box-warning box-solid">
    ...
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
      ...
      <tr>
        <td width='200'>Email / Kode Distributor <?php echo form_error('email') ?></td>
        <td><input type="text" class="form-control" name="email" id="email" placeholder="Email / Kode Distributor" value="<?php echo $email; ?>" /></td>
      </tr>
      <?php
      ...
      <tr>
        ...
        <td><?php echo cmb_dinamis('id_user_level', 'tbl_user_level', 'nama_level', 'id_user_level', $id_user_level,'ASC') ?> 
