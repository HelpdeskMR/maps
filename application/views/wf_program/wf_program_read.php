...
<div class="content-wrapper">
  ...
  <div class="box box-warning box-solid">
    ...
    <div style="padding-left:10px; padding-top:20px;"><b><?php if ($kode_departemen == '0306' || $kode_departemen == '0308' || $kode_departemen == '0307' || $kode_departemen == '0306401' || $kode_departemen == '0303') { echo 'PROMOTION DETAIL'; } else { echo 'ON TOP PROMO'; } ?></b></div>
    <table class="table-read">
      <thead bgcolor="#3C8DBC">
        <tr> 
          <!--td>No</td-->
    ...
    <div class="box-footer">
      ...
      <a href="<?php echo site_url('wf_program'); ?>" class="btn btn-info" style="margin-right:1%"><i class="fa fa-sign-out"></i> Cancel</a> <a href="<?php echo site_url('wf_program/approve_action/'.$promotion_id.''); ?>" class="btn btn-success"  style="margin-right:1%" onclick="javasciprt: return confirm('Are You Sure ?')"><i class="fa fa-floppy-o"></i> Approve</a>
...
<div class="modal fade" id="modal-reject<?php echo $data['promotion_id']; ?>">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="<?php echo site_url('wf_program/reject_action') ?>" method="post" class="form-horizontal" id="reject">
