...
<div class="row">
  <div class="col-xs-12"> <?php echo alert('alert-info', 'Perhatian', 'Silahkan Cheklist Pada Menu Yang Akan Diberikan Akses') ?>
    <div class="box box-warning box-solid">
      <div class="box-header">
        <h3 class="box-title">HAK AKSES UNTUK LEVEL : <b><?php echo $level['nama_level'] ?></b></h3>
      </div>
      <div class="box-body">
