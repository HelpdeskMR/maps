  ...
  <div class="content-wrapper">
    ...
    -->
        <table class="table">
          ...
          <tr>
            <td>
              <p><?php echo $sales_background; ?></textarea></p>
            </td>
            <td>
              <p><?php echo $sales_objective; ?></textarea></p>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            <td>
              <p><?php echo $sales_strategy; ?></p>
            </td>
            <td>
              <p><?php echo $sales_mechanism; ?></p>
            </td>
          </tr>
        </table>
    ...
    <?php } else { ?>
     ...
     /* FINANCIAL KPI */
    -->
    <?php if($kode_departemen == '0306' || $kode_departemen == '0306401' || $kode_departemen == '0303' && $gl_account_onTopPromo != '510051') { ?>
	  <?php } else { ?>
    ...
    -->
        <?php if (!empty($row_on_top_promo)) { ?>
          <div style="padding-left:10px; padding-top:20px;margin-bottom:10px;"><b><?php if ($kode_departemen == '0306' || $kode_departemen == '0306401' || $kode_departemen == '0303') {
