		...
		<div class="box box-warning box-solid">
			...
			<form action="<?php echo $action; ?>" method="post" class="form-horizontal" id="promotion_header" enctype="multipart/form-data">
				<div class="box-body">
					<div class="row">
						<div class="col-md-6">
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<select class="form-control select2" id="business_unit_id" name="business_unit_id" required style="width: 100%;" disabled>
										<option value="<?php echo $business_unit; ?>">
											<?php echo $business_unit_name; ?>
										</option>
									</select>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-9">
									<select class="form-control select2" id="kode_departemen" name="kode_departemen" required style="width: 100%;" disabled>
										<option></option>
										<?php $no = 0;
										foreach ($row_departemen as $row) : $no++; ?>
											<option value="<?php echo $row['kode_departemen']; ?>" <?php if ($row['kode_departemen'] == $kode_departemen) {
																										echo 'selected';
																									} ?>>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<select class="form-control select2" id="channel_code" name="channel_code" required style="width: 100%;" disabled>
										<option>
							...
							<?php if ($kode_departemen == "0306") { ?>
								<div class="form-group">
									...
									<div class="col-sm-9">
										<select class="form-control select2" style="width: 100%;" id="brand_code" name="brand_code" disabled>
											<option>
												<?php echo $brand_name; ?>
											</option>
										</select>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<select class="form-control select2" style="width: 100%;" id="series_code" name="series_code" disabled>
											<option>
							...
							<?php } else if ($kode_departemen == "0312") { ?>
								<div class="form-group">
									...
									<div class="col-sm-9">
										<select class="form-control select2" id="store_code" name="store_code" style="width: 100%;" disabled>
											<option>
												<?php echo $store_name; ?>
											</option>
										</select>
							...
							<?php } else if ($kode_departemen == "0305" && $channel_code == "002" || $channel_code == "003") { ?>
								<div class="form-group">
									...
									<div class="col-sm-9">
										<select class="form-control select2" id="region_code" name="region_code" style="width: 100%;" disabled>
											<option>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<select class="form-control select2" id="kode_area" name="kode_area" style="width: 100%;" disabled>
											<option></option>
										</select>
									</div>
								</div>
								<?php if (!empty($row_distributor)) { ?>
									<div class="form-group" id="dis">
										<label class="col-sm-3 control-label">Distributor</label>
										<div class="col-sm-9">
											<select class="form-control select2" multiple="multiple" data-placeholder="Select a State" style="width: 100%;" id="kode_distributor" name="kode_distributor[]">
												<?php $no = 0;
												foreach ($row_distributor as $row) : $no++; ?>
													<option value="<?php echo $row['kode_distributor']; ?>" selected><?php echo $row['nama_distributor']; ?></option>
												<?php endforeach; ?>
											</select>
										</div>
									</div>
						...
						<div class="col-md-6">
							...
							<div class="form-group">
								...
								<div class="col-sm-3">
									...
									<select class="form-control select2" name="fiscal_year" id="fiscal_year" disabled>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									...
									<?php if ($upload_file == NULL || $upload_file == '') { ?>
										<span>Tidak Ada</span>
									<?php } else { ?>
										<a href="<?php echo base_url('uploads/') ?><?php echo $upload_file; ?>"><?php echo $upload_file; ?></a>
									<?php } ?>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-9">
									...
									<?php if ($upload_activity == NULL || $upload_activity == '') { ?>
										<span>Tidak Ada</span>
									<?php } else { ?>
										<a href="<?php echo base_url('uploads/') ?><?php echo $upload_activity; ?>"><?php echo $upload_activity; ?></a>
									<?php } ?>
								</div>
							</div>
						</div>
					...
					<div class="col-md-12">
						...
						<div class="nav-tabs-custom">
							<ul class="nav nav-tabs">
								<li <?php if($this->session->userdata('kode_departemen') != '0306' || $this->session->userdata('kode_departemen') != '0306401' || $this->session->userdata('kode_departemen') != '0303') { echo 'class="active"';} ?> id="tradingTerm"><a href="#tab_1" data-toggle="tab" <?php if($this->session->userdata('kode_departemen') == '0306' || $this->session->userdata('kode_departemen') == '0306401' || $this->session->userdata('kode_departemen') == '0303') { echo 'style="display: none;"'; } ?>>TRADING TERM</a>
								</li>
								<li id="listingCost"><a href="#tab_3" data-toggle="tab" <?php if($this->session->userdata('kode_departemen') == '0306' || $this->session->userdata('kode_departemen') == '0306401' || $this->session->userdata('kode_departemen') == '0303') { echo 'style="display: none;"'; } ?>>LISTING COST</a>
								</li>
								<li <?php if($this->session->userdata('kode_departemen') == '0306' || $this->session->userdata('kode_departemen') == '0306401' || $this->session->userdata('kode_departemen') == '0303') { echo 'class="active"';} ?> id="onTopPromo"><a href="#tab_4" data-toggle="tab"><?php if($this->session->userdata('kode_departemen') == '0306' || $this->session->userdata('kode_departemen') == '0306401' || $this->session->userdata('kode_departemen') == '0303') { echo 'PROMOTION DETAIL'; } else { echo 'ON TOP PROMO'; } ?></a>
								</li>
								<li id="productList"><a href="#tab_2" data-toggle="tab">PRODUCT</a>
								</li>
							</ul>
							<div class="tab-content">
								<div class="tab-pane <?php if($this->session->userdata('kode_departemen') != '0306' || $this->session->userdata('kode_departemen') != '0306401' || $this->session->userdata('kode_departemen') != '0303') { echo 'active';} ?>" id="tab_1">
									<!-- / .TRADING TERM -->
									<div id="trading-field" <?php if($this->session->userdata('kode_departemen') == '0306' || $this->session->userdata('kode_departemen') == '0306401' || $this->session->userdata('kode_departemen') == '0303') { echo 'style="display: none;"'; } ?>>
										<table class="table table-wizard" id="trading_field" style="width: 100%;">
											...
											<?php $no = 0;
											foreach ($row_tradingTerm as $data) : $no++; ?>
												<tr>
													<td width="30%">
														<select class="form-control select2" id="trading_activity" name="trading_activity[]" style="width:100%" disabled>
															<option value="<?php echo $data['activity_id']; ?>"><?php echo $data['trading_activity_name']; ?></option>
														</select>
													</td>
													<td>
														<select class="form-control select2" id="trading_account_code" name="trading_account_code[]" style="width:100%" disabled>
															<option value="<?php echo $data['gl_account_code']; ?>"><?php echo $data['gl_coa_desc']; ?></option>
														</select>
													</td>
													<td><input type="text" class="form-control" id="trading_amount" name="trading_amount[]" value="<?php echo number_format($data['amount']); ?>" disabled /><span id="error_trading" class="text-danger"> </span>
													</td>
													<td>
													</td>
												</tr>
											...
											<tr>
												...
												<td>
													<select class="form-control select2" id="trading_account_code" name="trading_account_code[]" style="width:100%">
														<option></option>
														<?php $no = 0;
														foreach ($row_listBudget as $data) : $no++; ?>
															<?php if ($data['is_aktif'] == 'n') { ?>
																<option disabled title="Over Budget" value="<?php echo $data['gl_coa']; ?>"><?php echo $data['gl_coa_desc']; ?></option>
															<?php } else { ?>
																<option value="<?php echo $data['gl_coa']; ?>"><?php echo $data['gl_coa_desc']; ?></option>
															<?php } ?>
														<?php endforeach; ?>
													</select>
												</td>
								...
								<div class="tab-pane" id="tab_3">
									<!-- / .LISTING COST -->
									<div id="listing-field" <?php if($this->session->userdata('kode_departemen') == '0306' || $this->session->userdata('kode_departemen') == '0306401' || $this->session->userdata('kode_departemen') == '0303') { echo 'style="display: none;"'; } ?>>
										<table class="table table-wizard" id="listing_field" style="width: 100%;">
											...
											<?php $no = 0;
											foreach ($row_listingCost as $data) : $no++; ?>
												<tr>
													<td width="20%">
														<select class="form-control select2" id="listing_activity" name="listing_activity[]" style="width:100%" disabled>
															<option value="<?php echo $data->listing_activity; ?>"><?php echo $data->listing_activity_name; ?></option>
														</select>
													</td>
													<td>
														<select class="form-control select2" id="listing_account_code" name="listing_account_code[]" style="width:100%" disabled>
															<option value="<?php echo $data->gl_account_code; ?>"><?php echo $data->gl_coa_desc; ?></option>
														</select>
													</td>
													<td><input type="text" id="listing_amount" name="listing_amount[]" class="form-control" value="<?php echo number_format($data->amount); ?>" disabled /><span id="error_listing" class="text-danger"> </span>
													</td>
													<td><input type="text" id="listing_source_of_fund" name="listing_source_of_fund[]" class="form-control" value="<?php echo $data->source_fund; ?>" disabled />
													</td>
													<td><textarea class="form-control" rows="1" id="listing_remarks" name="listing_remarks[]" value="<?php echo $data->remark; ?>" disabled></textarea>
													</td>
													<td>
													</td>
												</tr>
								...
								<!-- /.tab-pane -->
								<div class="tab-pane <?php if($this->session->userdata('kode_departemen') == '0306' || $this->session->userdata('kode_departemen') == '0306401' || $this->session->userdata('kode_departemen') == '0303') { echo 'active';} ?>" id="tab_4">
									<!-- / .ON TOP PROMO -->
									<div id="promo-field">
										<table class="table table-wizard" id="promo_field" style="width: 100%;">
											<tr>
												...
												<?php if($this->session->userdata('kode_departemen') != '0306' && $this->session->userdata('kode_departemen') != '0306401' && $this->session->userdata('kode_departemen') != '0303') { ?>
												<td>Source Of Fund</td>
												<td>Remarks</td>
												<?php } ?>
												<td>Action</td>
											...
											<?php $no = 0;
											foreach ($row_onTopPromo as $data) : $no++; ?>
												<tr>
													<td width="30%">
														<?php if($this->session->userdata('kode_departemen') == '0306' || $this->session->userdata('kode_departemen') == '0306401' || $this->session->userdata('kode_departemen') == '0303') { ?>
															<input type="text" class="form-control" id="promo_activity" name="promo_activity[]" value="<?php echo $data->promo_activity_name; ?>" disabled/>
														<?php } else { ?>
															<select class="form-control select2" id="promo_activity" name="promo_activity[]" style="width:100%" disabled>
																<option value="<?php echo $data->activity_id; ?>"><?php echo $data->promo_activity_name; ?></option>
															</select>
														<?php } ?>
													</td>
													<td>
														<select class="form-control select2" id="promo_account_code" name="promo_account_code[]" style="width:100%" disabled>
															<option value="<?php echo $data->gl_account_code; ?>"><?php echo $data->gl_coa_desc; ?></option>
														</select>
													</td>
													<td><input type="text" class="form-control" id="promo_amount" name="promo_amount[]" value="<?php echo number_format($data->amount); ?>" disabled /><span id="error_promo" class="text-danger"> </span>
													</td>
													<?php if($this->session->userdata('kode_departemen') != '0306' && $this->session->userdata('kode_departemen') != '0306401' && $this->session->userdata('kode_departemen') != '0303') { ?>
													<td><input type="text" class="form-control" id="promo_source_of_fund" name="promo_source_of_fund[]" value="<?php echo $data->source_fund; ?>" disabled />
													</td>
													<td><textarea class="form-control" rows="1" id="promo_remarks" name="promo_remarks[]" value="<?php echo $data->remark; ?>" disabled><?php echo $data->remark; ?></textarea>
													</td>
													<?php } ?>
													<td>
													</td>
											...
											<tr>
												<td width="35%">
													<?php if($this->session->userdata('kode_departemen') == '0306' || $this->session->userdata('kode_departemen') == '0306401' || $this->session->userdata('kode_departemen') == '0303') { ?>
														<input type="text" class="form-control" id="promo_activity" name="promo_activity[]" value="<?php echo $promo_activity_name; ?>"/>
													<?php } else { ?>
								...
								<div class="tab-pane" id="tab_2">
									...
									<div id="product-field">
										...
										<table class="table table-wizard" id="product_field" style="width: 100%; ">
											...
											<?php if ($row_product != '' || $row_product != NULL) { ?>
												<?php $nomor = 0;
												foreach ($row_product as $data) : $nomor++; ?>
													<tr id="row<?php echo $nomor; ?>">
														<td width="25%">
															<select class="form-control select2" id="product_name" name="product_name[]" style="width:100%">
																<?php $no = 0;
																foreach ($row_listProduct as $row) : $no++; ?>
																	<option value="<?php echo $row['product_code']; ?>" <?php if ($row['product_code'] == $data->product_code) {
																															echo "selected";
																														} ?>><?php echo $row['product_name']; ?></option>
																<?php endforeach; ?>
															</select>
														</td>
														<td width="15%"><input type="text" name="baseline_sales[]" class="form-control" id="baseline_sales" value="<?php echo number_format($data->baseline_sales, 0, ",", ""); ?>" />
														</td>
														<td width="15%"><input type="text" name="incremental_sales[]" class="form-control" id="incremental_sales" value="<?php echo number_format($data->incremental_sales, 0, ",", ""); ?>" />
														</td>
														<td width="5%">
															<?php if ($nomor == 1) { ?>
																<button type="button" name="add" id="add" class="btn btn-success">Add</button>
															<?php } else { ?>
																<button type="button" name="remove" id="<?php echo $nomor; ?>" class="btn btn-danger btn_remove">Delete</button>
															<?php } ?>
														</td>
													</tr>
												<?php endforeach; ?>
											<?php } else { ?>
												<tr>
													<td width="25%">
														<select class="form-control select2" id="product_name1" name="product_name[]" style="width:100%">
															<option></option>
														</select>
													</td>
													<td width="15%"><input type="text" name="baseline_sales[]" class="form-control" id="baseline_sales1" value="<?php echo $baseline_sales; ?>" />
													</td>
													<td width="15%"><input type="text" name="incremental_sales[]" class="form-control" id="incremental_sales1" value="<?php echo $incremental_sales; ?>" />
													</td>
					...
					<!-- / .WIZARD END -->
					<!-- /.body -->
					<input type="hidden" class="form-control" name="promotion_id" id="promotion_id" value="<?php echo $promotion_id; ?>" />
					<input type="hidden" class="form-control" name="promotion_number" id="promotion_number" value="<?php echo $promotion_number; ?>" />
		...
		$( '#kode_departemen' ).change( function () {
			var id = $( this ).val();
				if(id == '0306'){
					...
					document.getElementById('brand').disabled = '';
					document.getElementById('series').disabled = '';
					document.getElementById('tradingTerm').style.display = 'none';
					document.getElementById('listingCost').style.display = 'none';
					document.getElementById('trading-field').style.display = 'none';
					document.getElementById('listing-field').style.display = 'none';
					//change active tab
					document.getElementById('tradingTerm').classList.remove('active');
					document.getElementById('tab_1').classList.remove('active');
					document.getElementById('listingCost').classList.remove('active');
					...
					document.getElementById('onTopPromo').classList.add('active');
				...
				// 	document.getElementById('series').disabled = 'disabled';
				// 	document.getElementById('tradingTerm').style.display = '';
				// 	document.getElementById('listingCost').style.display = '';
				// 	document.getElementById('trading-field').style.display = '';
				// 	document.getElementById('listing-field').style.display = '';
				// 	//change active tab
				// 	document.getElementById('onTopPromo').classList.remove('active');
				// 	document.getElementById('tab_4').classList.remove('active');
				// 	document.getElementById('productList').classList.remove('active');
				// 	document.getElementById('tab_2').classList.remove('active');
				// 	document.getElementById('listingCost').classList.remove('active');
				// 	document.getElementById('tab_3').classList.remove('active');
				// 	document.getElementById('tradingTerm').classList.add('active');
...
//					html = '<option></option>';
		...
		$( '#kode_departemen' ).change( function () {
			...
			document.getElementById('finish').disabled = 'disabled';
			$.ajax( {
				url: "<?php echo site_url('promotion_form/get_brand'); ?>",
				method: "POST",
				data: {
					id: id
				},
		...
		$( '#brand_code' ).change( function () {
			...
			document.getElementById('finish').disabled = 'disabled';
			$.ajax( {
				url: "<?php echo site_url('promotion_form/get_series'); ?>",
				method: "POST",
				data: {
					id: id,
					kode_departemen: kode_departemen
		...
		$( '#add1' ).click( function () {
			...
			$( '#listing_field' ).append( "<tr id='row" + j + "'>" +
				...
				"<td><select class='form-control select2' id='listing_account_code' name='listing_account_code[]' style='width:100%'><option></option><?php $no = 0;foreach ($row_listBudget as $data) : $no++; ?><?php if ($data['is_aktif'] == 'n') { ?><option disabled title='Over Budget' value='<?php echo $data['gl_coa']; ?>'><?php echo $data['gl_coa_desc']; ?></option><?php } else { ?><option value='<?php echo $data['gl_coa']; ?>'><?php echo $data['gl_coa_desc']; ?></option><?php } ?><?php endforeach; ?></select></td>" +
		...
		$( '#add2' ).click( function () {
			...
			$( '#promo_field' ).append( "<tr id='row" + k + "'>" +
				<?php if($this->session->userdata('kode_departemen') == '0306' || $this->session->userdata('kode_departemen') == '0306401' || $this->session->userdata('kode_departemen') == '0303') { ?>
				"<td width='180px'><input type='text' class='form-control' id='promo_activity' name='promo_activity[]' value='<?php echo $promo_activity_name; ?>' /></td>" +
				<?php } else { ?>
				...
				<?php } ?>
				"<td><select class='form-control select2' id='promo_account_code' name='promo_account_code[]' style='width:100%'><option></option><?php $no = 0;foreach ($row_listBudget as $data) : $no++; ?><?php if ($data['is_aktif'] == 'n') { ?><option disabled title='Over Budget' value='<?php echo $data['gl_coa']; ?>'><?php echo $data['gl_coa_desc']; ?></option><?php } else { ?><option value='<?php echo $data['gl_coa']; ?>'><?php echo $data['gl_coa_desc']; ?></option><?php } ?><?php endforeach; ?></select></td>" +
		...
		$( '#add3' ).click( function () {
			...
			$( '#trading_field' ).append( "<tr id='row" + l + "'>" +
				...
				"<td><select class='form-control select2' id='trading_account_code' name='trading_account_code[]' style='width:100%'><option></option><?php $no = 0;foreach ($row_listBudget as $data) : $no++; ?><?php if ($data['is_aktif'] == 'n') { ?><option disabled title='Over Budget' value='<?php echo $data['gl_coa']; ?>'><?php echo $data['gl_coa_desc']; ?></option><?php } else { ?><option value='<?php echo $data['gl_coa']; ?>'><?php echo $data['gl_coa_desc']; ?></option><?php } ?><?php endforeach; ?></select></td>" +
	...
	function ProcessExcel( data ) {
		...
		for ( var i = 0; i < excelRows.length; i++ ) {
			if(document.getElementById('kode_departemen').value == '0306' || document.getElementById('kode_departemen').value == '0306401' || document.getElementById('kode_departemen').value == '0303' && document.getElementById('promo_account_code').value == '510051'){
			...
			} else if(document.getElementById('kode_departemen').value == '0306' || document.getElementById('kode_departemen').value == '0306401' || document.getElementById('kode_departemen').value == '0303' && document.getElementById('promo_account_code').value != '510051') {
				//Add the data row.
				var row = table.insertRow( -1 );
				var product = document.createElement( "SELECT" );
				var baseline_sales = document.createElement( "INPUT" );
