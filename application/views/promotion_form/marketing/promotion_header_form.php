				...
				<div class="box-body">
					<div class="row">
						<div class="col-md-6">
							...
							<div class="form-group" style="display: none" id="brand">
							<label class="col-sm-3 control-label">Brand</label>
							<div class="col-sm-9">
								<select class="form-control select2" style="width: 100%;" id="brand_code" name="brand_code"></select>
							</div>
							</div>
							<div class="form-group" style="display: none" id="series">
								<label class="col-sm-3 control-label">Series</label>
								<div class="col-sm-9">
									<select class="form-control select2" style="width: 100%;" id="series_code" name="series_code"></select>
								</div>
							  </div>
							<div class="form-group" style="display: none" id="type_marketing">
						...
						<div class="nav-tabs-custom">
							...
							<div class="tab-content">
								...
								<div class="tab-pane" id="tab_2">
									...
									<div id="product-gratis" style="display: none;">
										<font color="#000" style="padding-left: 1%"> Upload Product ( Excel )</font>
										<div class="input-group margin col-sm-6">
											<input type="file" class="form-control" name="product_gratis_upload" id="product_gratis_upload"/>
											<div class="input-group-btn">
												<button type="button" class="btn btn-success" id="upload_product_gratis" onclick="Upload_product_gratis()"><i class="fa fa-upload" style="color: #fff"> Upload</i></a></button>
												<button type="button" class="btn btn-danger btn_remove_product_gratis" id="remove" name="remove_product_gratis"><i class="fa fa-remove" style="color: #fff"> Clear</i></a></button>
												<button type="button" class="btn btn-warning"><a href="<?php echo base_url('templates/Template_upload_product_gratis.xls') ?>"><i class="fa fa-download" style="color: #fff"> Download Template</i></a></button>
											</div>
										</div>
										<div id="dvExcel_gratis">
										</div>
										<table class="table table-wizard" id="product_gratis" style="width: 100%; ">
											<tr>
												<td>Product Name<span id="product_name_gratis-error" class="signup-error"></span>
												</td>
												<td>Qty<span id="qty-error" class="signup-error"></span>
												</td>
												<td>Action</td>
											</tr>
											<tr>
												<td width="25%">
													<?php echo cmb_dinamis2('product_name_gratis[]', 'product_list', 'product_name', 'product_code', $product_code, 'ASC', 'product_name_gratis') ?>
												</td>
												<td width="15%"><input type="text" name="qty_gratis[]" class="form-control" id="qty_gratis" value="<?php echo $qty_gratis; ?>"/>
												</td>
												<td width="5%"><button type="button" name="add4" id="add4" class="btn btn-success">Add</button>
												</td>
											</tr>
										</table>
									</div>
		...
		$( '#kode_departemen' ).change( function () {
			var id = $( this ).val();
				if(id == '0306'){
					...
					document.getElementById('type_marketing').style.display = '';
					document.getElementById('brand').disabled = '';
					document.getElementById('series').disabled = '';
					document.getElementById('type_marketing').disabled = '';
				...
				if(id == '0306401' || id == '0307' || id == '0308' || id == '0303' || id == '0323'){
					document.getElementById('type_marketing').style.display = '';
					document.getElementById('type_marketing').disabled = '';
				}
...
//					html = '<option></option>';
		...
		$( '#type' ).change( function () {
			...
			if(id == 2){
				...
				document.getElementById('baseline_sales').disabled = 'disabled';
				document.getElementById('incremental_sales').disabled = 'disabled';
				document.getElementById('product-gratis').style.display = '';
				document.getElementById('product_name_gratis').disabled = '';
				document.getElementById('qty_gratis').disabled = '';
			}
			
			if(id == 1) {
				document.getElementById('product-field').style.display = '';
				document.getElementById('product_name').disabled = '';
				document.getElementById('baseline_sales').disabled = '';
				document.getElementById('incremental_sales').disabled = '';
				document.getElementById('product-gratis').style.display = 'none';
				document.getElementById('product_name_gratis').disabled = 'disabled';
				document.getElementById('qty_gratis').disabled = 'disabled';
			}
		});
