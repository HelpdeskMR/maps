  ...
  <section class="content">
    ...
    -->
      ...
      <?php if ($row_reject_reason != NULL) { ?>
		  ...
		  <?php } ?>
      <div class="box-footer"> <a href="<?php echo site_url('promotion_form') ?>" class="btn btn-info"><i class="fa fa-sign-out"></i> Back</a> <a href="<?php echo site_url('promotion_form/pdf/' . $promotion_id . '') ?>" target="parent" class="btn btn-danger"><i class="fa fa-print"></i> Print</a></div>
    </div>
    </section>
</div>