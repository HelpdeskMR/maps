...
<div class="content-wrapper">
  <section class="content">
    <div style="padding-bottom: 10px;"><a href="<?php echo site_url('additional_budget') ?>" class="btn btn-info"><i class="fa fa-sign-out"></i> Back</a> <a href="<?php echo site_url('promotion_form/pdf/' . $promotion_id . '') ?>" target="parent" class="btn btn-danger"><i class="fa fa-print"></i> Print</a> </div>
    <div class="box box-warning box-solid">
      ...
      <table class='table' style="padding-top:20px">
        <tr>
          ...
          <td width="10px">:</td>
          <td style="border-bottom: 1px solid; border-color:#A2A2A2;" width="430px"><?php echo $promotion_number; ?></td>
        </tr>
        <tr>
          ...
          <td width="10px">:</td>
          <td style="border-bottom: 1px solid; border-color:#A2A2A2;" width="430px"><?php echo $channel_name; ?></td>
        </tr>
        <tr>
          ...
          <td width="10px">:</td>
          <td style="border-bottom: 1px solid; border-color:#A2A2A2;" width="430px"><?php echo $nama_region; ?></td>
        </tr>
        <tr>
          ...
          <td width="10px">:</td>
          <td style="border-bottom: 1px solid; border-color:#A2A2A2;" width="430px"><?php echo $nama_area; ?></td>
        </tr>
        <tr>
          ...
          <td width="10px">:</td>
          <td style="border-bottom: 1px solid; border-color:#A2A2A2;" width="430px"><?php echo $store_name; ?></td>
        </tr>
        <tr>
    ...
    -->
      ...
      <?php if ($row_reject_reason != NULL) { ?>
		  ...
		  <?php } ?>
      <div class="box-footer"> <a href="<?php echo site_url('additional_budget') ?>" class="btn btn-info"><i class="fa fa-sign-out"></i> Back</a> <a href="<?php echo site_url('promotion_form/pdf/' . $promotion_id . '') ?>" target="parent" class="btn btn-danger"><i class="fa fa-print"></i> Print</a></div>
    </div>
    </section>
</div>