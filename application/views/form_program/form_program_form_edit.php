    ...
    <form action="<?php echo $action; ?>" method="post">
      ...
      <table class='table table-bordered'>
        ...
        <tr>
          ...
          <td><?php echo cmb_dinamis('gl_coa', 'gl_account', 'gl_coa_desc', 'gl_coa', $program_id,'ASC') ?></td>
        </tr>
      </table>
      <table class='table table-bordered'>
        <tr>
      ...
      <table class='table table-bordered'>
        ...
        <tr>
          <td></td>
          <td><!--input type="hidden" class="form-control" name="secloguser" id="secloguser" value="?php echo $this->session->userdata('full_name'); ?>" readonly="readonly" /-->
            <!--input type="hidden" class="form-control" name="seclogdate" id="seclogdate" value="?php date_default_timezone_set('Asia/Jakarta'); $now = date('Y-m-d H:i:s');  echo $now; ?>"  readonly="readonly" /-->
            <!--input type="hidden" class="form-control" name="jenis_form" id="jenis_form"  value="PROGRAM" /-->
            <!--input type="hidden" class="form-control" name="kode_perusahaan" id="kode_perusahaan" value="01" /-->
