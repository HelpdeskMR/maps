...
<div class="content-wrapper">
	<section class="content">
		<div style="padding-bottom: 10px;">
			<a href="<?php echo site_url('welcome/waiting_promotion') ?>" class="btn btn-info"><i class="fa fa-sign-out"></i> Back</a> <a href="<?php echo site_url('promotion_form/pdf/' . $promotion_id . '') ?>" target="parent" class="btn btn-danger"><i class="fa fa-print"></i> Print</a> </div>
