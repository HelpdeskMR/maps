...
class Welcome extends CI_Controller
{
	...
	public function index()
	{
		...
		//Claim
		$row_claim = $this->Welcome_model->get_claim();
		$row_claim_waiting = $this->Welcome_model->get_claim_waiting($id_users);
		$row_claim_approve = $this->Welcome_model->get_claim_approve();
		$row_claim_reject = $this->Welcome_model->get_claim_reject();
		...
		$data['total_claim'] = $row_claim->jml_claim;
		$data['total_claim_waiting'] = $row_claim_waiting->jml_claim_waiting;
		$data['total_claim_approve'] = $row_claim_approve->jml_claim_approve;
		$data['total_claim_reject'] = $row_claim_reject->jml_claim_reject;
