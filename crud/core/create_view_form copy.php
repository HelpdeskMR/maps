    ...
    <section class=\"content\">
        <div class=\"box box-warning box-solid\">
            <div class=\"box-header with-border\">
                <h3 class=\"box-title\">INPUT DATA " .  strtoupper($table_title) . "</h3>
            </div>
...
foreach ($non_pk as $row) {
    if ($row["data_type"] == 'text') {
        ...
        $string .= "\n\t    <tr><td width='200'>" . label($row["column_name"]) . " <?php echo form_error('" . $row["column_name"] . "') ?></td><td><input type=\"email\" class=\"form-control\" name=\"" . $row["column_name"] . "\" id=\"" . $row["column_name"] . "\" placeholder=\"\" value=\"<?php echo $" . $row["column_name"] . "; ?>\" /></td></tr>";
